...
(function() {
  ...
  define("cordova/plugin/Media", function(require, exports, module) {
     ...
     */
    var Media = function(src, successCallback, errorCallback, statusCallback, initCallback) {
      try {
    ...
    Media.onStatus = function(id, msgType, value) {
      ...
      if (media) {
        switch (msgType) {
          case Media.MEDIA_INIT:
            media._duration = value.duration;
            media.initCallback && media.initCallback();
            break;
